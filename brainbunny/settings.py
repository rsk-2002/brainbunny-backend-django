...
# For local developement - ENVIRONMENT=development
...
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "brainbunny.up.railway.app"]
...
STATICFILES_DIRS = [BASE_DIR / "static"]  # folder location
